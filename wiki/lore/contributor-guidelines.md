...
Sinverse is an **open setting**. It was always meant to be a shared world rather than one creator's private sandbox — a place where anyone who's drawn to its themes can add a story, a piece of art, a character, or a corner of lore. If you've been reading or looking and thinking *I'd like to make something for this*, that's exactly the point. You're welcome here.

This page is a friendly overview of how contributing works and what we ask of contributors. None of it is meant to be a gate — it's the shared understanding that keeps the world consistent and the community a good place to be.

## Everything goes through Jay

Jay is the custodian of Sinverse, and all contributions are coordinated through him. The best way to reach him is in the **community Discord** — that's his primary means of contact, and where you'll get the quickest answer about anything below. If you have something you'd like to add, or you're just figuring out where to start, that's the place to say hello.

## What you can contribute, and how each is handled
...
Beyond the rules, Sinverse runs on a simple ethic: be generous, be welcoming, and make the world richer for the next person who shows up. Offer feedback kindly. Assume good faith. Help newcomers find their footing. The setting is big enough for wildly different visions to coexist, and it's better for it.

Welcome to Sinverse. I'm glad you're here. - *Jay*
