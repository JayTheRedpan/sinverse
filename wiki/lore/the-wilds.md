...
type: location
title: The Wilds
tags: [wilds, wild-toys, bastion, the-paws, huntresses, macro, location, resistance]
---

## Overview

The Wilds are everything that is not a mega-city — and that is very nearly the entire planet. Where the [mega-cities](mega-cities) are islands of steel and concrete, the Wilds are the ocean around them: vast, overgrown, and monstrous, sprawling across the overwhelming majority of the world's surface. They are at once the most terrifying place a toy can be and the only place a toy can be free, and that contradiction is the whole of what the Wilds are.
...
The fauna is the louder one. Animals grew to enormous and sometimes outright monstrous scale, and size alone made gentle creatures lethal. It is not unusual to see a toy devoured by a doe the size of a building — a placid, harmless herbivore in every respect but the one that matters, cropping vegetation and swallowing whatever small thing happens to be among it without ever registering that it has killed. The Wilds are full of such ends: deaths delivered without intent by things too large to notice them.

And the Wilds are still getting worse. Every mega-city's [SinCorp](sincorp) branch runs its own undisclosed research, and when a laboratory tires of a creation — an experiment grown inconvenient, unstable, or simply boring — the simplest disposal is to release it into the Wilds and let the country swallow it. Whatever those experiments become, they become it out there, adding their own new horrors to a place that needed none.
...
- [Toys](toys) — those who flee to the Wilds
- [The Huntresses (The Paws)](the-paws) — who range the Wilds to capture them
- [Bastion](bastion) — the rumoured permanent toy city hidden somewhere within
- [The Mega-Cities](mega-cities) — the islands the Wilds surround
- [The Resistance](the-resistance) — which uses the Wilds' vastness as cover
- [The Apotheosis Serum](apotheosis-serum) — the TDay Variant that overgrew the world
- [SinCorp](sincorp) — whose discarded experiments are loosed into the Wilds

## Did You Know

- The Wilds cover the overwhelming majority of the planet's surface. The mega-cities, for all their size, are tiny islands by comparison — the new world is mostly wilderness, with civilisation the exception.
- Some of the densest regions of the Wilds never see direct sunlight, the mutated canopy having grown into an unbroken roof hundreds of feet overhead.
- A toy in the Wilds is as likely to be killed by something with no intention of harming him — a grazing giant herbivore, a feeding plant — as by anything that means it.
- When a SinCorp lab tires of an experiment, the cheapest way to dispose of it is to release it into the Wilds. No one tracks what becomes of them.
- Wild Toys are among the most valuable catches in the trade precisely because they are unclaimed and battle-hardened — which is why the **Paws** brave the Wilds to hunt them.
- There are persistent rumours of a large, established Wild Toy settlement called [**Bastion**](bastion). No mega-city has confirmed it exists.
- Wild Toys have developed informal warning networks across vast distances — signal fires, marked trails, and coded messages left in ruins — that pre-date any formal Resistance organisation.
- Some regions of the Wilds have not been entered by any known living person since TDay. The Resistance calls these "blank zones" and avoids them.
