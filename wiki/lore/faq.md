...
The crucial thing to understand is that the serum removes a **brake** rather than installing a hunger. She feels no compulsion to be cruel — she feels nothing that would stop her. And the void left behind is wired to reward the **exercise of dominion** over a toy in whatever form she prefers it: ownership, command, obedience, adoration, fear, indulgence, use, or cruelty. It keys on **power, not pain**. Cruelty is one expression among many, not a requirement — which is why giantesses range from outright sadists (for whom a toy's torment is the whole point, savoured rather than incidental) to doting collectors to cold administrators, all of them equally in its grip. What none of them can do without is *toys*: the reward is a real need, and a giantess with nothing beneath her to satisfy it on slowly comes apart. It is a symbiosis — toys need giantesses to survive the world, and giantesses need toys to remain themselves.
